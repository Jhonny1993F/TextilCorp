...
namespace TextilCorp.Controllers
{
    public class CarritosController : Controller
    {
        ...
        {
            ViewData["ClienteId"] = new SelectList(_context.Set<Cliente>(), "ClienteId", "ClienteId");
        ...
        public async Task<IActionResult> Create([Bind("CarritoId,Cantidad,ClienteId,ProductoId")] Carrito carrito)
        {
            ...
            ViewData["ClienteId"] = new SelectList(_context.Set<Cliente>(), "ClienteId", "ClienteId", carrito.ClienteId);
            ViewData["ProductoId"] = new SelectList(_context.Set<Producto>(), "ProductoId", "ProductoId", carrito.ProductoId);
            return View(carrito);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarritoId,Cantidad,ClienteId,ProductoId")] Carrito carrito)
        {
