    ...
    public class MarcasController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Marca != null ? 
                          ...
                          Problem("Entity set 'TextilCorpContext.Marca'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("MarcaId,Cantidad,Descripcion")] Marca marca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MarcaId,Cantidad,Descripcion")] Marca marca)
        {
            if (id != marca.MarcaId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TextilCorpContext.Marca'  is null.");
            }
            var marca = await _context.Marca.FindAsync(id);
            if (marca != null)
            {
